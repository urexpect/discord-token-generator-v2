...
# Captcha API-------------------REQUIRED!!!!!!!!!!!!!!!!!!!
anticaptcha = 'e406ba428b71b2ca6fc65192'
capmonster = 'e94d822ba627b9116e797ac1'
captcha_type = 'capmonster'  # Set which captcha api to use

# Email API-------------------OPTIONAL
kopeechka = '0afcf16125ff85f24f341158dee'
gmailnator = '28d361d7ed3b8p1b924fjsnddc67ade2aa7'
tempgmail = '28d36f41b7msh303988p1b924fjsnddc67ade2aa7'
...
def createAccount():
    ...
    try:
        ...
        print("Proxy Error occurred... Retrying in 5s")
        time.sleep(5)
